...
const menuModels: Record<string, MegaDefinition> = {
  ...
  Directors: {
    eyebrow: "Directors",
    title: "Executive directors driving the RACTYSH vision.",
    description: "Meet the four Directors leading RACTYSH Associates, RACTYSH Design, RACTYSH Infra and RACTYSH Exim.",
    image: "/images/photo-1518005020951-eccb494ad742.webp",
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: "B. Mohamed Jamaldheen", description: "Director — RACTYSH Exim Pvt Ltd.", href: "/directors", Icon: Building2 }
        ]
      }
    ]
  }
...
const quickAccessSearchItems: SearchItem[] = [
  ...
  },
  {
    ...
    href: "/directors",
    Icon: Building2,
    keywords: ["directors", "leadership", "executive", "ashok", "naveen", "subash", "mohamed", "jamaldheen", "exim", "infra", "board"]
  },
  {
    title: "Blog",
