...
export const pageSeo: Record<string, PageSeo> = {
  ...
  "/contact": {
    title: "Contact Ractysh | Architecture, Construction, Real Estate & Enterprise Solutions",
    description:
      "Get in touch with Ractysh Group. Office at D.NO:129A, MARUTHUVANAGAR, Palani, Dindigul, Tamil Nadu, India, 624601. Email ractyshgroup@gmail.com or call +91 9080844114.",
    keywords: ["contact Ractysh", "Ractysh Associates", "Ractysh Group contact", "architecture firm Tamil Nadu", "construction company Dindigul", "real estate Palani"],
  },
  "/founder": {
